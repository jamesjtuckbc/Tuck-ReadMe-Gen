...
inquirer.prompt([
    ...
    .then((data) => {
        ...
        const licenseText = li.choseLicense(license,userName);
...
${test}
## Questions
Please reach-out to me on [GitHub](www.github.com/${gitHub}) or email me at: [${email}](mailto:${email})`;
